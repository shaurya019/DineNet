...
export const BottomSubmitComponent: React.FC<BottomSubmitComponentProps> = ({
  Heading,
  outOfStock,
  submit,
  setSubmit,
  ...
  useEffect(() => {
    if (complimentaryOrderData != null) {
      if (
        ...
        textRequest.length > 0 &&
        category !== 'NotDisclosed'
      ) {
        const Order = {
  ...
  return (
    <div
      className="fixed bottom-0 w-full bg-white border-t-whiteSmoke mt-10 py-3 px-2.5"
      style={{
        boxShadow: '0 -4px 4px 0px rgba(0, 0, 0, 0.07)',
        minHeight: '60px',
      }}>
      ...
      {outOfStock ? (<>
        <div className="bg-greyCyan text-center py-3 rounded-2xl">
