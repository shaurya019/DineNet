...
export interface BackArrowProps extends React.SVGAttributes<SVGSVGElement> {
  fillColor?: string;
}

export const BackArrow: React.FC<BackArrowProps> = ({ fillColor = "white", ...props }) => {
  ...
  return (
    <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleGoBack} {...props}>
